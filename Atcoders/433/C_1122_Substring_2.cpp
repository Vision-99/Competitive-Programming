...
/*
    "1122 string"
    len even 
    first half have same char 
    second half also have same char 
    s.back() - s[0] == 1
    ex. "12", "1122", "3344"

    find all "1122 substr of s"
    n is 1e6 , nlogn ,nsqrt(n), or n just 2-pointers 

    plain bf- > n^3
    same as sprinkler 1st OA problem- 50 pointer

    try this
    1112222334445556555
    s.back() - s[0] == 1 , this say adj char must differ by 1 and mst be inc.
    so , 12, 23, ..., 78, 89 are only possible string type 
    no. of substr = length of 1st half/2

    always use while loop in this type of problem
