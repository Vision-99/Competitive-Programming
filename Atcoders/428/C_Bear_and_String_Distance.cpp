...
/*
    each char can give you at max 25, by using prev char, z for a , b for c
    this is wrong it's cyclic dist , dist(a,b) = 1  
    so just make char a or z, which ever is far, if still k>0 return -1
