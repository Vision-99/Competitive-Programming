...
/*
    cnt of substr of S, such that its subseq is not T
    as |T| is 50, so subseq check is O(1), but substr is still O(n^2)
    So do total - that are subseq
    and use dp so it will be O(m*n)
*/
