...
if(d%3 == 0 || n>=3) cout<<3<<" ";
if(d%5==0) cout<<5<<" ";
if(d%7==0 || n>=3) cout<<7<<" ";   // n>=3 means fact >=6(6,24,120...) all multiple of 6
// and we know the fact that id count of digits is multiple of 6 and d==1 it's a multiple of 7
