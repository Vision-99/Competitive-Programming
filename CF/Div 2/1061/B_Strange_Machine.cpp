...
/*
    A means x--;
    B means x/=2;
    num of ops. req to make x '0'
    find a way to do it in O(1), using details of s
    have a prefix of pair of type of op. 
    or there might be some bitmanupilation stuff that might help 
    to perform each query in log(a[i]);
    or is it just bf with condition of all A, edge case
    yes, cs if any B found it will at max take 32 cycl.
*/
...
void I_still_love_her() {
    ...
    // if f=1, no B found ans is just the num
