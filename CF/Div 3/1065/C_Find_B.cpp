...
/*
    single ele -> no
    cnt of 1 > sz/2 -> no
    not eaxctly , take ex. a = [1,1,3] , you say NO , but we can make [2,2,1] ans is YES
    So in reallty you must check subarray sum with sz and cnt of 1, if sum/sz > 1 , YES
    ...
    to answer each query use prefix sum
