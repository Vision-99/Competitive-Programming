...
/*
    ...
    just bf?
    in int range only at max. 1 house possimbel
    17394 this much car,
    1740262 this much comp.
    or just do bf for a,b and check for c
    this problem is simillar to distribute candy among childrens 
